...
public:
    int numberOfBeams(std::vector<std::string>& bank) 
    {
        ...
        for (int i = 0; i < bank.size(); i++)
        {
            ...
            {
                answ += prevCounter * currentCounter;
    ...
    int numberOfBeams_vers2(std::vector<std::string>& bank)
    {
        std::ios_base::sync_with_stdio(false);
        ...
        for (int i = 0; i < bank.size(); i++)
        {
            ...
            answ += prevCounter * currentCounter;
            prevCounter = currentCounter > 0 ? currentCounter : prevCounter;
        }
...
int main()
{
    ...
    std::cout << s.numberOfBeams_vers2(bank) << std::endl;
